...
namespace WebBrowserOnTransparentWindow
{
    ...
    {
        Window _owner;
       public  FrameworkElement _placementTarget;
        ...
        public WebBrowserOverlayWF(FrameworkElement placementTarget)
        {
           ...
           // _placementTarget.Visibility = Visibility.Collapsed;
       ...
       public void OnSizeLocationChanged()
        {
            ...
            if (_repositionCallback == null)
                _repositionCallback = _owner.Dispatcher.BeginInvoke((Action)delegate { Reposition(); }, DispatcherPriority.Input);
        }
