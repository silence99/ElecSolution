...
namespace Framework
{
    internal class StrategyRegistry : Dictionary<NotificationObject, SortedSet<Tuple<string, PropertyChangedHandlerEx, PropertyChangedHandlerEx>>>
    {
        ...
        public void Invoke(NotificationObject notifier, PropertyChangedEventArgsEx args, PropertyChangeEvent eventType)
        {
            if (notifier != null)
            {
        ...
        private void Register(NotificationObject notifier, string propertyName, PropertyChangedHandlerEx changingHandler, PropertyChangedHandlerEx changedHandler)
        {
            lock (_syncObj)
            {
                if (notifier != null)
        ...
        private void Unregister(NotificationObject notifier, string propertyName, PropertyChangedHandlerEx changingHandler, PropertyChangedHandlerEx changedHandler)
        {
            lock (_syncObj)
            {
                if (notifier != null)
