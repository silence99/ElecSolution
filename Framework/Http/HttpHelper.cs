...
namespace Framework.Http
{
    ...
    public class HttpHelper
    {
        ...
        private void SetRequest(HttpItem objhttpItem)
        {
            ...
            SetCer(objhttpItem);
            //设置Header参数
            if (objhttpItem.Header != null)
            {
                request.Headers = objhttpItem.Header;
            }
            // 设置代理
    ...
    public class HttpItem
    {
        ...
        string _ContentType = "application/json; text/html";
        /// <summary>
        /// 请求返回类型默认 text/html
        /// </summary>
    ...
    public class HttpCommon
    {
        ...
        public static string HttpGet(string AUrl, string ACookie)
        {
        ...
        {
            return HttpPost(AUrl, AParam, "", AContentType);
        }

        public static string HttpPost(string AUrl, string AParam, string ACookie, string AContentType)
        {
            HttpHelper hh = new HttpHelper();
            HttpItem hi = new HttpItem();
