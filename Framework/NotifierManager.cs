...
namespace Framework
{
    internal class NotifierManager
    {
        ...
        private Dictionary<NotificationObject, SortedSet<string>> _notifiers = new Dictionary<NotificationObject, SortedSet<string>>();
        ...
        public void RegisterToNotify(NotificationObject sender, string property)
        {
