...
namespace Framework
{
    public class NotificationObject : INotifyPropertyChangedEx, INotifyPropertyChangingEx, INotifyPropertyChanged
    {
        ...
        private void InvokeEventAndRepositoryRegisterHandlers(PropertyChangedEventArgsEx args, PropertyChangeEvent period)
        {
            ...
            var stackitem = new KeyValuePair<NotificationObject, string>(this, args.PropertyName);
            try
            {
